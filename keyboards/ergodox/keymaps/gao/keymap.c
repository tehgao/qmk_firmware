...
[0] = KEYMAP(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_ESCAPE,KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,KC_LBRACKET,CTL_T(KC_CAPSLOCK),KC_A,KC_S,KC_D,KC_F,KC_G,MEH_T(KC_NO),KC_Z,KC_X,KC_C,KC_V,KC_B,MO(1),KC_LCTL,KC_GRAVE,KC_BSLASH,KC_LALT,TG(1),CTL_T(KC_F5),GUI_T(KC_F9),KC_DELETE,SFT_T(KC_SPACE),KC_LSHIFT,LCTL(KC_LALT),KC_ESCAPE,KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINUS,KC_RBRACKET,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_DELETE,KC_H,KC_J,KC_K,KC_L,LT(2,KC_SCOLON),CTL_T(KC_QUOTE),MO(2),KC_N,KC_M,KC_COMMA,KC_DOT,CTL_T(KC_SLASH),ALL_T(KC_NO),KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,GUI_T(KC_ENTER),KC_LALT,CTL_T(KC_ESCAPE),KC_PGUP,KC_PGDOWN,KC_ENTER,KC_BSPACE),
